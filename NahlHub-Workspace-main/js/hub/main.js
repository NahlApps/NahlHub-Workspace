...
(function () {
  ...
  // Check dependencies
  if (!window.NH_CONFIG) throw new Error("NH_CONFIG is missing. Include /js/hub/config.js first.");
  if (!window.NH_I18N) throw new Error("NH_I18N is missing. Include /js/hub/i18n.js first.");
  if (!window.NH_UI) throw new Error("NH_UI is missing. Include /js/hub/ui.js first.");
  if (!window.NH_API_CLIENT) throw new Error("NH_API_CLIENT is missing. Include /js/hub/api-client.js first.");
  if (!window.NH_AUTH) throw new Error("NH_AUTH is missing. Include /js/hub/auth.js first.");
  if (!window.NH_WORKSPACE) throw new Error("NH_WORKSPACE is missing. Include /js/hub/workspace.js first.");
  if (!window.NH_APPS) throw new Error("NH_APPS is missing. Include /js/hub/apps.js first.");
